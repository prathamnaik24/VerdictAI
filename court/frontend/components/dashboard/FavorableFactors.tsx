  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        <div style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#B69D74', flexShrink: 0 }} />
      ...
      {factors.length === 0 ? (
        <p style={{ fontSize: '13px', color: 'rgba(31,40,57,0.4)', fontStyle: 'italic' }}>
          No favorable factors identified in this assessment.
        </p>
      ) : (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          {factors.map((factor, i) => (
            <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
              ...
              >
                <span style={{ fontSize: '10px', fontWeight: 800, color: '#B69D74' }}>✓</span>
              </div>
